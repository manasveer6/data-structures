...
int main() {
    ...
    printf("***************************************************************\n");
    printf("*                                                             *\n");
    printf("*            Welcome to Doubly Linked List Program            *\n");
    printf("*                                                             *\n");
    printf("***************************************************************\n");
...
//INCOMPLETE. Sorts the Linked List in ascending order using bubble sort algorithm.
...
//INCOMPLETE. Reverses the Linked List.
